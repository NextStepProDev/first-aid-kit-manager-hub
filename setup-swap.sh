#!/usr/bin/env bash
#
# setup-swap.sh — konfiguracja 2 GB swap dla serwera produkcyjnego First Aid Kit.
#
# Krytyczne dla maszyny produkcyjnej o ograniczonej pamieci (~1 GB RAM): bez
# swapu backend (Java/Spring) + PostgreSQL laduja OOM. Tworzy /swapfile, ustawia
# swappiness 10 i utrwala obie rzeczy na reboot (fstab + sysctl).
#
# Uzycie (raz, przy pierwszym deploy / odtworzeniu serwera):
